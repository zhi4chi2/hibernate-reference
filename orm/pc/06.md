...
public class Test {
    public static void main(String[] args) {
        ...
        // class org.example.demo.hibernate.Test$Person
        System.out.println(p.getClass());
        // org.example.demo.hibernate.Test$Person@59221b97
...
```
则第 25 行将抛 java.lang.NullPointerException
...
public class Test {
    public static void main(String[] args) {
        ...
        // class org.example.demo.hibernate.Test$Person
        System.out.println(p.getClass());
        // org.example.demo.hibernate.Test$Person@72bca894
        System.out.println(p);
...
```
则第 37 行将抛 java.lang.NullPointerException


Session.get 实际调用 Session.byId load ，参见 org.hibernate.internal.SessionImpl.get(Class, Serializable) 方法。
...
public class Test {
    public static void main(String[] args) {
        ...
        Person p = session.byId(Person.class).load(person.id);
        // class org.example.demo.hibernate.Test$Person
        System.out.println(p.getClass());
        // org.example.demo.hibernate.Test$Person@72bca894
        System.out.println(p);
...
如果将第 35 行改为
```java
        Person p = session.byId(Person.class).load(2);
```
则第 37 行将抛 java.lang.NullPointerException
...
public class Test {
    public static void main(String[] args) {
        ...
        Optional<Person> optionalPerson = session.byId(Person.class).loadOptional(person.id);
        // class java.util.Optional
        System.out.println(optionalPerson.getClass());
        // org.example.demo.hibernate.Test$Person@72bca894
...
如果将第 37 行改为
```java
        Optional<Person> optionalPerson = session.byId(Person.class).loadOptional(2);
```
则第 41 行抛 java.util.NoSuchElementException: No value present
