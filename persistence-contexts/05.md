...
public class Test {
    public static void main(String[] args) {
        ...
        // class org.example.demo.hibernate.Test$Person_$$_jvst169_0
        System.out.println(p.getClass());
        // 如果没有下面这句，则将不会查询数据库
        // org.example.demo.hibernate.Test$Person@1f2d2181
...
```
则第 28 行将抛异常 javax.persistence.EntityNotFoundException: Unable to find org.example.demo.hibernate.Test$Person with id 2


注意第 30 行输出 null 这是因为 runtime proxy 只能使用 getter/setter 不能使用 fields 取值。注意这不是指 access strategy 要为 property-based ，而是因为 runtime proxy 只 override 了 getter/setter 方法，而不改变 field 的值。
...
public class Test {
    public static void main(String[] args) {
        ...
        // class org.example.demo.hibernate.Test$Person_$$_jvsta0_0
        System.out.println(p.getClass());
        // 如果没有下面这句，则将不会查询数据库
        // org.example.demo.hibernate.Test$Person@22db8f4
        System.out.println(p);
        // null
        System.out.println(p.name);
        // 测试人
...
```
第 40 行将抛异常
org.hibernate.ObjectNotFoundException: No row with the given identifier exists: [org.example.demo.hibernate.Test$Person#2] 。注意与 JPA 抛的异常类不一样。
