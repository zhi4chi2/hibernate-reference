...
public class Test {
    public static void main(String[] args) {
        ...
        // class org.example.demo.Test$Person
        System.out.println(p.getClass());
        // org.example.demo.Test$Person@3add81c4
...
public class Test {
    public static void main(String[] args) {
        ...
        // class org.example.demo.Test$Person
        System.out.println(p.getClass());
        // org.example.demo.Test$Person@1fe8d51b
        System.out.println(p);
...
```
则第 38 行将抛 java.lang.NullPointerException
...
```
则第 42 行抛 java.util.NoSuchElementException: No value present
